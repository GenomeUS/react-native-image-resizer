...
class ImageResizerModule extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public void createResizedImage(final String imagePath, final int newWidth, final int newHeight, final String compressFormat, final int quality, final int rotation, final Callback successCb, final Callback failureCb) {
        ...
        new GuardedAsyncTask<Void, Void>(getReactApplicationContext()) {
            ...
            protected void doInBackgroundGuarded(Void... params) {
                try {
                    createResizedImageWithExceptions(imagePath, newWidth, newHeight, compressFormat, quality, rotation, successCb, failureCb);
                }
                catch (IOException e) {
